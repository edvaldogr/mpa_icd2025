...
##Inserindo células de código

A @fig-glinha exibe um gráfico de linha de uma variável aleatória com 
distribuição normal padronizada.

```{r}
#| echo: false
#| label: fig-glinha
#| fig-cap: "Gráfico de Linha de uma VA com distribuição normal."

# simulando uma VA com distribuição normal
retornos <- rnorm(1000)
...
O modelo CAPM foi desenvolvido em dois artigos clássicos de Finanças 
[@sharpe1964; @markowitz1952].
